...
const doc=await io.read('artifacts/ogimachi-phases/runtime-irori-interior-v3/irori-restaurant-v5.glb');
...
await io.write('public/models/ogimachi/irori-restaurant-interior-v3.glb',doc);
