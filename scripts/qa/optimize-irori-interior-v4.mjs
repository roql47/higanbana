...
const doc=await io.read('artifacts/ogimachi-phases/runtime-irori-interior-v4/irori-restaurant-v5.glb');
...
await io.write('public/models/ogimachi/irori-restaurant-interior-v4.glb',doc);
