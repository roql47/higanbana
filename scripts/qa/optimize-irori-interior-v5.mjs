...
const doc=await io.read('artifacts/ogimachi-phases/runtime-irori-interior-v5/irori-restaurant-v5.glb');
...
await io.write('public/models/ogimachi/irori-restaurant-interior-v5.glb',doc);
