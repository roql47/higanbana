...
const doc=await io.read('artifacts/ogimachi-phases/runtime-irori-interior-v2/irori-restaurant-v5.glb');
...
await io.write('public/models/ogimachi/irori-restaurant-interior-v2.glb',doc);
